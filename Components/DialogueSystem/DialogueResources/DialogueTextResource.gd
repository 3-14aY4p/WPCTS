...
@export var speaker_name: String #always add space before the nam
@export var speaker_img: Texture
@export var speaker_img_rest_frame: int = 0 #after dialogue is done
